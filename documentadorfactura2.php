...
<div id="apDiv2">
  ...
  <form name="form1" method="post" action="documentadorfactura3.php">
    <p>&nbsp;</p>
    <table width="316" border="0">
      <tr>
        <td width="150">Nombre Empresa:</td>
        <td width="150"><input type="text" name="12" id="12"></td>
      </tr>
      <tr>
        <td>RUT Empresa:</td>
      ...
      <tr>
        <td><label for="15">Centro de Costo</label>
:</td>
        <td><input type="text" name="15" id="15"></td>
      </tr>
      <tr>
        <td>Codigo de Gastos:</td>
